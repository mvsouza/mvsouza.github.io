...
This and other awsome themes can be found [on Github](http://github.com/mmistakes/). 
I`m pretty happy to find it, and with it learn more about Jekyll and other fun stuff.
Thank's [you](https://github.com/mmistakes/hpstr-jekyll-theme), for the great job.
